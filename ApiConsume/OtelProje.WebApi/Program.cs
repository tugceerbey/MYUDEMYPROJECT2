...
using Otelproje.BusinessLayer1.Concrete;
...
builder.Services.AddScoped<ISubscribeService, ISubscribeManager>();
...
builder.Services.AddScoped<IGuestService, IGuestManager>();
