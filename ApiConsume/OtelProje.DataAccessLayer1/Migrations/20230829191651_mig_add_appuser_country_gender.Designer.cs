...
namespace OtelProje.DataAccessLayer1.Migrations
{
    ...
    [Migration("20230829191651_mig_add_appuser_country_gender")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.About", b =>
                {
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.AppUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.Booking", b =>
                {
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.Contact", b =>
                {
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.Guest", b =>
                {
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.MessageCategory", b =>
                {
                    b.Property<int>("MessageCategoryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.SendMessage", b =>
                {
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.WorkLocation", b =>
                {
                    b.Property<int>("WorkLocationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("OtelProje.EntityLayer1.Concrete.AppRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("OtelProje.EntityLayer1.Concrete.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.AppUser", b =>
                {
                    b.HasOne("OtelProje.EntityLayer1.Concrete.WorkLocation", "WorkLocation")
                        .WithMany("AppUsers")
            ...
            modelBuilder.Entity("OtelProje.EntityLayer1.Concrete.Contact", b =>
                {
                    b.HasOne("OtelProje.EntityLayer1.Concrete.MessageCategory", "MessageCategory")
                        .WithMany("Contacts")
